    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.code == 200) {
                ...
                $('#errorMessageModal #errors').html('Whooops algo salio mal!');
            }
        },
        error: function () {
            $('#errorMessageModal').modal('show');
...
function deleteChat(id){
    ...
    BootstrapDialog.show({
        title: 'Chat Delete!',
        message: 'Estas seguro que queres borrar el chat ?',
        buttons: [{
            ...
            action: function(dialog) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        dialog.close();
                        if (response.code == 200){
                            $('.dm .chat').html(" <p style='padding: 20px;'> Chat borrado! </p> ");
...
function deleteMessage(id){
    ...
    BootstrapDialog.show({
        ...
        message: 'Estas seguro que queres borrar el mensaje ?',
        buttons: [{
            label: "Si!",
            cssClass: 'btn-danger',
            action: function(dialog) {
