                        ...
                        @if($my_profile)
                            ...
                            <form id="form-upload-profile-photo" enctype="multipart/form-data">
                                <div class="change-image">
                                    <a href="javascript:;" class="upload-button" onclick="uploadProfilePhoto()"><i class="fa fa-upload"></i> Subi Tu Foto</a>
                    ...
                    @if($my_profile)
                        <form id="form-upload-cover" enctype="multipart/form-data">
                            <div class="profile-upload-cover">
                                <a href="javascript:;" class="btn btn-info upload-button" onclick="uploadCover()" > Cambia la portada</a>
                    ...
                    @else
                        <div class="profile-follow">
                            <div class="profile-follow-b1 pull-left" style="margin-right: 10px">
                                {!! App\Library\sHelper::followButton($user->id, Auth::id(), '.profile-follow-b1') !!}
                            </div>
                            <div class="profile-follow-b2 pull-right">
                                {!! App\Library\sHelper::deniedButton(Auth::id(), $user->id, '.denied-button-'.$user->id, 'denied-button-'.$user->id) !!}
                            </div>
                        </div>
                    @endif
                </div>
