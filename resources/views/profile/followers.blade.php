                    ...
                    <div class="col-md-9">
                        ...
                        @if($list->count() == 0)
                            <div class="alert-message alert-message-danger">
                                <h4>Seguidores no encontrados.</h4>
                            </div>
                        @else
                            <div class="row">
                                                ...
                                                <div class="front">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="bottom" id="followers-button-{{ $relation->follower->id }}">
                                                            {!! App\Library\sHelper::followButton($relation->follower->id, Auth::id(), '#followers-button-'.$relation->follower->id, '.btn-no-refresh') !!}
                                                            {!! App\Library\sHelper::deniedButton(Auth::id(), $relation->follower->id, '.denied-button-'.$relation->follower->id, 'denied-button-'.$relation->follower->id) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        @else
            <div class="container">
                <div class="alert-message alert-message-default">
                    ...
                    <p>Seguir para ver a {{ '@'.$user->username."'s" }} perfil.</p>
                </div>
            </div>
        @endif
