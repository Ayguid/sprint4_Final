        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content-page-title">
                    Solicitud de seguidores ({{ $list->count() }})
                </div>


                @if($list->count() == 0)
                    <div class="alert-message alert-message-danger">
                        <h4>Solicitudes no encontradas.</h4>
                    </div>
                @else
                    <div class="row">
                                        ...
                                        <div class="front">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom" id="approve-buttons-{{ $relation->id }}">
                                                    <div class="text-success approved" style="display: none"><i class="fa fa-check"></i> Aprobado</div>
                                                    <div class="text-danger denied" style="display: none"><i class="fa fa-times"></i> Denegado</div>
