        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                {{-- <div class="content-page-title">
                    <i class="fa fa-commenting"></i> Mensajes directos
                </div> --}}
                ...
                <div class="new-message-button">
                    <button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#userListModal">
                        <i class="fa fa-commenting"></i> Nuevo Mensaje
                    </button>
                </div>
                <div class="dm">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="user_list">
                                @if($user_list->count() == 0)
                                    <div class="alert alert-danger" role="alert" style="margin: 10px;">No hay nadie que te siga, un bajon!!</div>
                                @else
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="modal-search"  onkeyup="searchUserList()" placeholder="Busca el nombre..">
                                    </div>
                                    <table id="modal-table">
                                        @foreach($user_list->get() as $f)
                                            <tr>
